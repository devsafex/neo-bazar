  ...
  return (
    <div className="w-full mx-auto">
      <div className="flex items-center justify-start gap-2 pb-2">
        ...
        <p className="max-w-2/3 bg-gray-200 py-1 px-2 rounded text-xs md:text-sm lg:text-base">
          I have bought a toy was broken. What to do?
        </p>
      </div>
      <div className="flex items-center justify-end gap-2 pb-2 pr-2">
        <p className="max-w-2/3 bg-green-100 py-1 px-2 rounded text-xs md:text-sm lg:text-base">
