  ...
  return (
    <div className="flex flex-col lg:flex-row gap-20 my-10 md:my-16  justify-center items-center  ">
      <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-[#00C982]/5 text-gray-900">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <input type="email" name="email" id="email" required placeholder="Enter Your Email Here" className="w-full px-3 py-2 border border-slate-200 focus:outline-[#00C982] text-gray-900" />
            </div>
            <div>
              <label htmlFor="password" className="text-sm mb-2">Password</label>
              <input type="password" name="password" autoComplete="current-password" id="password" required placeholder="*******" className="w-full px-3 py-2 border border-slate-200 focus:outline-[#00C982] text-gray-900" />
            </div>
        ...
        <div onClick={handleGoogleSignIn} className="flex justify-center border-slate-200 items-center space-x-2 border my-3 p-2 rounded-lg cursor-pointer">
          <FcGoogle size={32} />
          <p>Continue with Google</p>
        </div>
        <p className="px-6 text-sm text-center text-gray-500">
        Not registered? <Link to="/signup" className="hover:underline hover:text-[#00C982] font-medium text-black">Create account</Link>
        </p>
      </div>
    </div>
  );
