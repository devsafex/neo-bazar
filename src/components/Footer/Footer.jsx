...
const LINKS = [
      ...
      {
            title: "Product",
            items: ["Men's Fashion", "Women's Fashion", "Electronics", "Home & Kitchen", "Beauty & Health"],
      },

      {
            title: " Quick Links",
            items: ["Become a seller", "My orders", "New Arrivals", "Offers & Discounts", "Gift Cards"],
      },
      {
            title: "Policies & Legal",
            items: ["Privacy Policy", "Terms & Conditions", "Return & Refund Policy", "Shipping Policy", "Cookie Policy"],
      },
      {
            title: "Support & Help",
            items: ["Live Chat Support", "Call Support", "Email Support", "Help Center", "Account Recovery"],
      },
            ...
            <footer className="relative w-full">
                  <div className="mx-auto w-full max-w-7xl px-4 lg:px-0">
                              ...
                              <div className="md:hidden mx-auto mb-8 space-y-4">
                                    <div>
                                          <Link to="/" className=" flex items-center justify-center  mx-auto">
                                                <img className={`h-12 md:w-12 ${whiteLogo && "brightness-0 invert"}`} src="https://i.imgur.com/pZLDPsa.png" alt="" />
                                                <div className={` md:block text-2xl text-start font-bold ${whiteLogo ? "text-white" : "text-[#00C982]"}`}>
                                                      <h1>NEO</h1>
                                    ...
                                    <div className="flex space-x-3 justify-center">
                                          ...
                                          <Link> <FaTwitter className="text-blue-400 hover:text-blue-600" size={20} /> </Link>
                                          <Link>  <FaInstagram className="text-pink-600 hover:text-pink-800" size={20} /></Link>
                                    </div>
                              </div>
                        ...
                        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                              ...
                              >
                                    &copy; {currentYear} ❤️ <strong>Neo Bazar</strong> - Developed by <a href="https://github.com/devsafex" target="_blank" className="text-blue-500 hover:underline">Devsafex Team</a>. All Rights Reserved.
                              </Typography>
